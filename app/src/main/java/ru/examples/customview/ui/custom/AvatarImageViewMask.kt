...
import ru.examples.customview.R
...
): ImageView(context, attrs,defStyleAttrs)
{
    ...
    init {
        if(attrs !=null){
            ...
            borderWidth = ta.getDimension(R.styleable.AvatarImageViewMask_aivm_borderWidth, context.dpToPx(DEFAULT_BORDER_WIDTH))
    ...
    private fun prepereBitmaps(w: Int, h: Int)
    {
        ...
        maskPaint.xfermode = PorterDuffXfermode(PorterDuff.Mode.SRC_IN)  // алгоритм наложения одной битмапы на другую Портера Дафа
